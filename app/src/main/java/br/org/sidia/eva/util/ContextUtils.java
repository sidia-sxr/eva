...
public final class ContextUtils {
    ...
    public static boolean isMetaDataSet(@NonNull Context context, @NonNull String metaDataName) {
        String value = ContextUtils.getMetaDataValue(context, metaDataName);
